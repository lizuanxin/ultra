...
@Component({ selector: 'receiv', templateUrl: './receiving.cmp.html' })
export class ReceivingComponent implements OnInit
{
    ...
    CityList: string[] = [];
    Delivery: FormGroup;
    DeliveryControlName = { Recipient: FormControl, Tel: FormControl, Country: FormControl, City: FormControl, Street: FormControl, Zip: FormControl };
